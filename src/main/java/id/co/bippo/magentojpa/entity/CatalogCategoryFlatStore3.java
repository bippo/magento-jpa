...
/**
 * The persistent class for the catalog_category_flat_store_3 database table.
 * 
 */
@Entity
@Table(name="catalog_category_flat_store_3")
public class CatalogCategoryFlatStore3 implements Serializable {
    ...
    public CatalogCategoryFlatStore3() {
    }

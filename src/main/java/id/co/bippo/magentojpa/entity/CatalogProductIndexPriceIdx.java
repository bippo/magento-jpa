...
/**
 * The persistent class for the catalog_product_index_price_idx database table.
 * 
 */
@Entity
...
public class CatalogProductIndexPriceIdx implements Serializable {
	...
	@EmbeddedId
	private CatalogProductIndexPriceIdxPK id;
	...
	public CatalogProductIndexPriceIdxPK getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceIdxPK id) {
		this.id = id;
	}

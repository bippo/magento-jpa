...
/**
 * The persistent class for the catalog_product_index_price_bundle_opt_tmp database table.
 * 
 */
@Entity
...
public class CatalogProductIndexPriceBundleOptTmp implements Serializable {
	...
	@EmbeddedId
	private CatalogProductIndexPriceBundleOptTmpPK id;
	...
	public CatalogProductIndexPriceBundleOptTmpPK getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceBundleOptTmpPK id) {
		this.id = id;
	}

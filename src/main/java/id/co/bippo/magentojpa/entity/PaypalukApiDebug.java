...
/**
 * The persistent class for the paypaluk_api_debug database table.
 * 
 */
@Entity
@Table(name="paypaluk_api_debug")
public class PaypalukApiDebug implements Serializable {

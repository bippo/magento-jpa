...
/**
 * The persistent class for the catalog_category_flat_store_2 database table.
 * 
 */
@Entity
@Table(name="catalog_category_flat_store_2")
public class CatalogCategoryFlatStore2 implements Serializable {
    ...
    public CatalogCategoryFlatStore2() {
    }

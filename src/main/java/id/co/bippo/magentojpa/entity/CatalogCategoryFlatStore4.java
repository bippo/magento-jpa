...
/**
 * The persistent class for the catalog_category_flat_store_4 database table.
 * 
 */
@Entity
@Table(name="catalog_category_flat_store_4")
public class CatalogCategoryFlatStore4 implements Serializable {
    ...
    public CatalogCategoryFlatStore4() {
    }

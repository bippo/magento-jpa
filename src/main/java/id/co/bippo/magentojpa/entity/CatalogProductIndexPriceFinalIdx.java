...
/**
 * The persistent class for the catalog_product_index_price_final_idx database table.
 * 
 */
@Entity
...
public class CatalogProductIndexPriceFinalIdx implements Serializable {
	...
	@EmbeddedId
	private CatalogProductIndexPriceFinalIdxPK id;
	...
	public CatalogProductIndexPriceFinalIdxPK getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceFinalIdxPK id) {
		this.id = id;
	}

...
/**
 * The persistent class for the catalog_product_flat_1 database table.
 * 
 */
@Entity
@Table(name="catalog_product_flat_1")
public class CatalogProductFlat1 implements Serializable {

...
/**
 * The persistent class for the catalog_product_flat_5 database table.
 * 
 */
@Entity
@Table(name="catalog_product_flat_5")
public class CatalogProductFlat5 implements Serializable {

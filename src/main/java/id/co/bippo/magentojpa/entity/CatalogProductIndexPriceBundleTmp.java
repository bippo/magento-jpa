...
/**
 * The persistent class for the catalog_product_index_price_bundle_tmp database table.
 * 
 */
@Entity
...
public class CatalogProductIndexPriceBundleTmp implements Serializable {
	...
	@EmbeddedId
	private CatalogProductIndexPriceBundleTmpPK id;
	...
	public CatalogProductIndexPriceBundleTmpPK getId() {
		return this.id;
	}

	public void setId(CatalogProductIndexPriceBundleTmpPK id) {
		this.id = id;
	}

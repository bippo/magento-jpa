...
/**
 * The persistent class for the catalog_product_flat_4 database table.
 * 
 */
@Entity
@Table(name="catalog_product_flat_4")
public class CatalogProductFlat4 implements Serializable {

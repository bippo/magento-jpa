...
/**
 * The persistent class for the coupon_aggregated database table.
 * 
 */
@Entity
@Table(name="coupon_aggregated")
public class CouponAggregated implements Serializable {

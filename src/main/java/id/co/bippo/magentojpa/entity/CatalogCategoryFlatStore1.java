...
/**
 * The persistent class for the catalog_category_flat_store_1 database table.
 * 
 */
@Entity
@Table(name="catalog_category_flat_store_1")
public class CatalogCategoryFlatStore1 implements Serializable {
    ...
    public CatalogCategoryFlatStore1() {
    }
